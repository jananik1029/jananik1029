...
**Automation Test Engineer** with 4 Years of experience in designing, developing, and executing automated test scripts across a variety of applications and platforms. Proficient in using Cypress for automated testing, ensuring comprehensive test coverage of web applications. Strong reporting and documentation skills, demonstrating the ability to communicate effective testing. Sound knowledge on Procurement Life Cycle.
